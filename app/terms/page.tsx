        ...
        <div className="mx-auto max-w-4xl px-6 space-y-12">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              These Terms of Service govern your use of Metube. By accessing or
          ...
          <TermBlock title="Acceptable Use">
            You agree to use Metube only for lawful purposes. You must not use
          ...
          <TermBlock title="No Data Storage">
            Metube transfers files directly between connected devices using
            peer-to-peer technology. We do not store or retain your files on our
            servers.
          </TermBlock>

          <TermBlock title="Limitation of Liability">
            Metube is provided "as is" without warranties of any kind. We are
